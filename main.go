...
func main() {
	...
	router.Handle("/product-warehouse/available-stock", middleware.JWTMiddleware(http.HandlerFunc(productWarehouseHandler.GetAvailableStock))).Methods(http.MethodPost)
